...
const RemovetenantcheckpaymentlinkPage = () => {
    ...
    <>
      <div className="flex flex-col font-montserrat items-end justify-start mx-auto md:pl-10 sm:pl-5 pl-[910px] w-full">
        <div className="bg-blue_gray-900_01 flex flex-col items-center justify-end p-[22px] md:px-5 w-full">
          <div className="flex flex-col items-start justify-start mb-[53px] mt-[77px] w-[97%] md:w-full">
            ...
            <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mt-[61px] w-full">
              <Button
                ...
                onClick={() => navigate("/removetenantpaymentnotrecieved")}
                shape="round"
              ...
              <Button
                className="!text-gray-500_02 border border-gray-700_01 border-solid cursor-pointer font-medium leading-[normal] min-w-[332px] text-2xl md:text-[22px] text-center sm:text-xl"
                shape="round"
                color="blue_gray_900_01"
                size="xl"
                variant="fill"
...
export default RemovetenantcheckpaymentlinkPage;
