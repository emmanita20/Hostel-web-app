...
const RemovetenantcheckPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="flex flex-col font-montserrat items-end justify-start mx-auto md:pl-10 sm:pl-5 pl-[910px] w-full">
        <div className="bg-blue_gray-900_01 flex flex-col items-center justify-end p-[38px] md:px-5 w-full">
          <div className="flex flex-col items-start justify-start mb-[37px] mt-[61px] w-[99%] md:w-full">
            ...
            <Text
              className="mt-[33px] text-2xl md:text-[22px] text-white-A700 sm:text-xl"
              size="txtMontserratMedium24"
            >
              Seems Like something is Missing
            </Text>
            <div className="flex flex-row gap-3 items-start justify-start mt-[43px] w-[39%] md:w-full">
              <Img
            ...
            <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start mt-5 w-[64%] md:w-full">
              <Img
                className="h-9 w-9"
            ...
            <div className="bg-blue_gray-900_01 border border-gray-800_06 border-solid flex flex-col items-start justify-start md:ml-[0] ml-[3px] mt-[49px] p-[17px] rounded-[5px] w-full">
              <Text
            ...
            <Button
              className="cursor-pointer font-medium leading-[normal] min-w-[730px] md:min-w-full mt-[134px] text-2xl md:text-[22px] text-center sm:text-xl"
              shape="round"
              color="red_500_01"
              size="md"
              variant="fill"
            ...
            <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mt-[61px] w-full">
              <Button
                className="common-pointer !text-cyan-A200 border-2 border-cyan-800 border-solid cursor-pointer font-medium leading-[normal] min-w-[332px] text-2xl md:text-[22px] text-center sm:text-xl"
              ...
              <Button
                className="common-pointer cursor-pointer font-medium leading-[normal] min-w-[332px] text-2xl md:text-[22px] text-center sm:text-xl"
                onClick={() => navigate("/removeteantmoneyrecovery")}
                shape="round"
                color="cyan_800"
                size="xl"
                variant="fill"
...
export default RemovetenantcheckPage;
