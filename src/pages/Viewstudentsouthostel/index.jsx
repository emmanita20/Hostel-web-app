...
const ViewstudentsouthostelPage = () => {
  const [group641value, setGroup641value] = React.useState("");
                ...
                <Input
                  ...
                  suffix={
                    <CloseSVG
                      ...
                      onClick={() => setGroup641value("")}
                      style={{
                        visibility:
                          group641value?.length <= 0 ? "hidden" : "visible",
                      }}
                      height={24}
                      width={24}
                      viewBox="0 0 24 24"
...
export default ViewstudentsouthostelPage;
