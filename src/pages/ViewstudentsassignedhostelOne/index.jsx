...
const ViewstudentsassignedhostelOnePage = () => {
  const [group887value, setGroup887value] = React.useState("");
      ...
      <div className="flex flex-col font-montserrat items-end justify-start mx-auto md:pl-10 sm:pl-5 pl-[748px] w-full">
        <div className="bg-blue_gray-900_01 flex flex-col items-start justify-end p-3 md:px-5 w-full">
          <div className="flex flex-col gap-[19px] justify-start mb-[3px] mt-8 w-[92%] md:w-full">
            <div className="flex flex-col items-start justify-start ml-3.5 md:ml-[0] w-[54%] md:w-full">
              <Img
                className="h-6 w-6"
              ...
              />
              <Text
                className="mt-[33px] md:text-3xl sm:text-[28px] text-[32px] text-white-A700"
                size="txtMontserratMedium32"
              >
                Students Assigned Room
              </Text>
              <div className="flex sm:flex-col flex-row gap-2.5 items-center justify-between mt-[26px] w-full">
                <Input
                  name="group887"
                  placeholder="Search ..."
                  value={group887value}
                  onChange={(e) => setGroup887value(e)}
                  ...
                  suffix={
                    <CloseSVG
                      ...
                      onClick={() => setGroup887value("")}
                      style={{
                        visibility:
                          group887value?.length <= 0 ? "hidden" : "visible",
                      }}
                      height={24}
                      width={24}
                      viewBox="0 0 24 24"
...
export default ViewstudentsassignedhostelOnePage;
