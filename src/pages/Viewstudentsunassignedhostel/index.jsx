...
const ViewstudentsunassignedhostelPage = () => {
  const [group800value, setGroup800value] = React.useState("");
                ...
                <Input
                  ...
                  suffix={
                    <CloseSVG
                      ...
                      onClick={() => setGroup800value("")}
                      style={{
                        visibility:
                          group800value?.length <= 0 ? "hidden" : "visible",
                      }}
                      height={24}
                      width={24}
                      viewBox="0 0 24 24"
...
export default ViewstudentsunassignedhostelPage;
