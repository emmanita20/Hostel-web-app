...
const ViewstudentsassignedhostelPage = () => {
  const [group787value, setGroup787value] = React.useState("");
                ...
                <Input
                  ...
                  suffix={
                    <CloseSVG
                      ...
                      onClick={() => setGroup787value("")}
                      style={{
                        visibility:
                          group787value?.length <= 0 ? "hidden" : "visible",
                      }}
                      height={24}
                      width={24}
                      viewBox="0 0 24 24"
...
export default ViewstudentsassignedhostelPage;
