...
const ViewstudentsinhostelPage = () => {
  const [group230value, setGroup230value] = React.useState("");
                ...
                <Input
                  ...
                  suffix={
                    <CloseSVG
                      ...
                      onClick={() => setGroup230value("")}
                      style={{
                        visibility:
                          group230value?.length <= 0 ? "hidden" : "visible",
                      }}
                      height={24}
                      width={24}
                      viewBox="0 0 24 24"
...
export default ViewstudentsinhostelPage;
