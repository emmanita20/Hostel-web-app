...
const HostelfurniturereportdamagePage = () => {
  return (
    <>
      <div className="flex flex-col font-montserrat items-end justify-start mx-auto md:pl-10 sm:pl-5 pl-[910px] w-full">
        <div className="bg-blue_gray-900_01 flex flex-col justify-start p-[50px] md:px-5 w-full">
          <Img
          ...
          />
          <Text
            className="ml-20 md:ml-[0] mt-[68px] text-4xl sm:text-[32px] md:text-[34px] text-center text-white-A700 w-[63%] sm:w-full"
            size="txtMontserratMedium36"
          >
            Payment Link Sent to Defaulter Successfully
          </Text>
          <div className="flex flex-col items-start justify-start mb-[282px] ml-3 md:ml-[0] mr-[133px] mt-32 w-4/5 md:w-full">
            <Text
...
export default HostelfurniturereportdamagePage;
