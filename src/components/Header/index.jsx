  ...
  return (
    <>
      <header className={props.className}>
        ...
        <div
          className="bg-cover bg-no-repeat flex flex-col h-[81px] items-center justify-start md:ml-[0] ml-[19px] md:mt-0 mt-[49px] w-[14%] md:w-full"
        ...
        >
          ...
          >
            <div className="flex flex-row gap-[9px] items-center justify-center mb-2 w-[73%] md:w-full">
              <Img
                className="h-6 w-6"
                src="images/img_materialsymbol_cyan_a200_24x24.svg"
                alt="materialsymbol"
              />
              <Text
        ...
        <Button
          className="common-pointer bg-transparent cursor-pointer flex items-center justify-center mb-[33px] min-w-[168px] md:ml-[0] ml-[18px] md:mt-0 mt-[71px]"
